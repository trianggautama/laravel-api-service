...
<div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-1">Update quiz question and answer options</p>
        </div>
                                ...
                                <div class="option-item">
                                    <div class="flex items-center space-x-3">
                                        <div class="flex items-center justify-center w-10 h-10 border border-gray-300 rounded-lg bg-gray-50">
                                            <input type="radio" name="is_correct" value="{{ $index }}" {{ $option->is_correct ? 'checked' : '' }} class="w-4 h-4 text-blue-600 focus:ring-blue-500">
                                        </div>
                                        <input type="text" 
